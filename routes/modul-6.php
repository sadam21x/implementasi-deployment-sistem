...
Route::get('/scoreboard/client/sse', 'modul6\ScoreBoardController@sse_team');

Route::get('/scoreboard/controller/sse/reset', 'modul6\ScoreBoardController@sse_reset');
Route::post('/scoreboard/controller/sse/team', 'modul6\ScoreBoardController@sse_team_server');
